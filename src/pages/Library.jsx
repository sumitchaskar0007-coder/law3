...
<<<<<<< HEAD
          ...
          { name: "Loksatta", href: "https://www.loksatta.com" },
          { name: "Times of India", href: "https://timesofindia.indiatimes.com" },
          { name: "Maharashtra Times", href: "https://maharashtratimes.com" },
          { name: "Pudhari", href: "https://www.pudhari.news" },
          { name: "Lokmat", href: "https://www.lokmat.com" }
        ].map((paper, index) => (
          <motion.a
            key={index}
            href={paper.href}
...
<<<<<<< HEAD
          {[
            ...
            { name: "Gokhale Institute Library", href: "https://www.gokhaleinstitute.org/library" }
          ].map((lib, index) => (
            <motion.a
              key={index}
              href={lib.href}
...
<<<<<<< HEAD
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-gray-600">Email: jadhavarlawadmission@gmail.com</span>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
